...
***Detaylı proje raporu, atıflar ve görev detayları "TEKNOFEST_TYDA_On_Tasarim_Raporu" adı altında bulunmaktadır***
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-ENELPİ-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/fatmaNurToklu/ENELPI)
...
### 🔗 Kullanılan Ollama Modelleri

| Model | Rol |
|-------|-----|
| [`gemma3:4b`](https://ollama.com/library/gemma3:4b) | Varsayılan LLM — NER çıkarımı, resmî yazı taslağı üretimi ve birim yönlendirme kararlarında kullanılır |
| [`gemma2:9b`](https://ollama.com/library/gemma2:9b) | Opsiyonel, daha güçlü LLM — daha yüksek doğruluk gereken senaryolarda `gemma3:4b` yerine devreye alınabilir |
| [`nomic-embed-text`](https://ollama.com/library/nomic-embed-text) | Embedding modeli — mevzuat metinlerini vektörleştirip ChromaDB üzerinde RAG sorgularını besler |
...
- [Kullanım](#-kullanım)
- [Ekran Görüntüleri ve Sistem İşleyişi](#-ekran-görüntüleri-ve-sistem-i̇şleyişi)
...
Sistemin dil modeli altyapısı tamamen yerel olarak **Ollama** üzerinden çalışır. Varsayılan LLM olarak **`gemma3:4b`** kullanılır ve içerik analizi (NER), resmî yazı taslağı üretimi ile birim yönlendirme kararlarında görev alır; daha yüksek doğruluk gereken durumlarda opsiyonel olarak **`gemma2:9b`** modeline geçilebilir. Mevzuat metinleri ise **`nomic-embed-text`** embedding modeliyle vektörleştirilerek ChromaDB üzerinde RAG (Retrieval-Augmented Generation) sorgularında kullanılır — bu sayede Ajan 2, ilgili mevzuat hükümlerini anlamsal benzerlik üzerinden bulup taslak üretimine referans olarak sunabilir.
...
| **LLM** | Ollama (`gemma3:4b` / `gemma2:9b`) | NER, taslak üretimi, birim yönlendirme |
